...
public class capNhatChamCongView extends JDialog {
	...
	public capNhatChamCongView() {
		...
		formPanel.add(thangLamViecTF);
		{
			...
			imgLabel.setIcon(new ImageIcon(capNhatChamCongView.class.getResource("/img/planning.png")));
