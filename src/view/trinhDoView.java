...
public class trinhDoView {
	...
	public trinhDoView() {
		...
		panel_1.setBounds(22, 269, 926, 415);
		tab4.add(panel_1);
		...
		scrollPane.setBounds(31, 83, 871, 426);
		...
		scrollPane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
				...
				txtTnPhngBan.setForeground(Color.GRAY);
						...
						btnNewButton_1.setBounds(288, 10, 33, 37);
		...
		btnNewButton_2 = new JButton("+ Thêm kỹ năng");
		...
		btnNewButton_2.setBounds(52, 205, 181, 37);
