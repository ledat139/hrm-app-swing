...
public class nhanVienView {
	...
	private ArrayList<nhanVien> nhanVienData = nhanVienDAO.getInstance().selectAll();
	...
	public nhanVienView() {
		...
		String thuocTinh[] = {"Mã NV", "Họ Tên", "Giới tính", "Ngsinh", "SDT", "Email", "Địa chỉ", "CCCD", "Cấp bậc",
				"Mã PB"};
