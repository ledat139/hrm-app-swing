...
public class capNhatTaiKhoanView extends JDialog {
	...
	public capNhatTaiKhoanView() {
		...
		String maPB[] = {"P01", "P02", "..."};
		{
			...
			imgLabel.setIcon(new ImageIcon(capNhatTaiKhoanView.class.getResource("/img/account sticker.png")));
